...
const robbingLoseMoneyHandler = {
  ...
  async handle(handlerInput) {
    ...
    sessionAttributes.currentIntent = "robbingLoseMoneyHandler";

    await robbing.computeLoseCredits(handlerInput, sessionAttributes.victim);
    speakOutput = await strings.strings(handlerInput, "outOfTurns");
...
module.exports = robbingLoseMoneyHandler;
